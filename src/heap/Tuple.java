...
/** get the length of a tuple, call this method if you did 
  ...
  */
  ...
  {           
   ...
   /**
    * Convert this field into a shape
    *
    * @param    fldNo   the field number
    * @return           the shape if success
    *			
    * @exception   IOException I/O errors
    * @exception   FieldNumberOutOfBoundException Tuple field number out of bound
    */

   public Shape getShapeFld(int fldNo) 
   	throws IOException, FieldNumberOutOfBoundException 
    {   
      ...
      if ( (fldNo > 0) && (fldNo <= fldCnt))      
       {
    	  ...
    	  Shape shape = Convert.getShapeValue(fldOffset[fldNo -1], data);
   ...
   */
   ...
   public Tuple setShapeFld(int fldNo, Shape val) 
		  	throws IOException, FieldNumberOutOfBoundException
		  { 
		    if ( (fldNo > 0) && (fldNo <= fldCnt))
		     {
			Convert.setShapeValue (val, fldOffset[fldNo -1], data);
			return this;
		     }
		    else 
		     throw new FieldNumberOutOfBoundException (null, "TUPLE:TUPLE_FLDNO_OUT_OF_BOUND"); 
