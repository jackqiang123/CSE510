...
class newJoinsDriver implements GlobalConst {
...
//    Query6();
  ...
  public void Query1() {
   ...
   // sailors.addElement(new Sailor(63, "James Larus",        9, 30.3));
    ...
    //Tuple tt3 = am.get_next();
    
    try {
    	while(am.get_next() != null)
		{Tuple tt = am.get_next();
		//tt.get
		System.out.println("i am here");

		System.out.println(tt.getStrFld(2));
		}
  ...
  public void Query2() {
   ...
   System.out.print("**********************Query5 strating *********************\n");  
    ...
    System.out.println("i am going to show the inserted data");
    try {
		while(am.get_next() != null)
		{	
			Tuple tt = am.get_next();
...
public class JoinTest
{
  public static void main(String argv[])
  {
    ...
    newJoinsDriver jjoin = new newJoinsDriver();
