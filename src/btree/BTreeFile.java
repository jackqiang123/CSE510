...
public class BTreeFile extends IndexFile 
  ...
  public void insert(KeyClass key, RID rid) 
	...
	if ( headerPage.get_keyType() != AttrType.attrString ) {
      ...
      {
    	  //System.out.println("checking key type in btreefile ln 396");
    	  if (headerPage.get_keyType() != AttrType.attrShape)
    	  {
    		  throw new KeyNotMatchException(null, "");
    	  }
      }
	...
	//System.out.println("checking new root page in btreefile: ln 429" + " and header page is: " + headerPage.get_keyType());
	newRootPage=new BTLeafPage( headerPage.get_keyType());
	
	//System.out.println("created new root page in btreefile: ln 432" + " and new root page id: " + newRootPage.getCurPage());
	...
	//System.out.println("inserting record into root in ln 452 and key = " + key);
